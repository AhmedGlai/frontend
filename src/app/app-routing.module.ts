...
import { DashboardComponent as DashboardComponent1 } from './admin/dashboard/dashboard.component';


import { SpecialtiesAdminComponent } from './admin/specialties-admin/specialties-admin.component';
import { PatientAdminComponent } from './admin/patient-admin/patient-admin.component';
import { DoctorAdminComponent } from './admin/doctor-admin/doctor-admin.component';
...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      {
        path: "admin", component: AdminComponent, canActivate: [PatGuardGuard], children: [
          { path: "", component: DashboardComponent1, canActivate: [PatGuardGuard] },
          { path: "patient", component: PatientAdminComponent, canActivate: [PatGuardGuard] },
          { path: "doctor", component: DoctorAdminComponent, canActivate: [PatGuardGuard] },
          { path: "specialties", component: SpecialtiesAdminComponent, canActivate: [PatGuardGuard] },
